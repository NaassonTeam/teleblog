...
Step 1 downloads the script. Step 2 makes it executable. Step 3 runs it. The script will ask for language, folder, and handle Docker. Then open http://localhost:7433.
